    ...
    <div class="profile-settings">
        <div class="block">
            ...
            <a-form :model="basicInfoForm" layout="vertical" autocomplete="off" @finish="handleChangeInfo">
                ...
                <a-form-item>
                    <a-button block type="primary" html-type="submit" :loading="updateInfoLoading">Сақтау</a-button>
                </a-form-item>
            </a-form>
        </div>
        ...
        <div class="block">
            ...
            <a-form :model="changePasswordForm" layout="vertical" autocomplete="off" @finish="handleChangePassword">
                ...
                <a-form-item>
                    <a-button block type="primary" html-type="submit" :loading="changePasswordLoading">Сақтау</a-button>
                </a-form-item>
            </a-form>
        </div>
